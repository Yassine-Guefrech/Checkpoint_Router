  ...
  return (
   <div>
        ...
        <Routes>
          ...
          <Route path='/Listmovie' element={<ListMovies movies={movies} setMovies={setMovies} titre={titre} etoile={etoile}/>}/>
